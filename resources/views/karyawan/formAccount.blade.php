            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- form start -->
                        @foreach($data as $dt)
                        <form role="form" action="{{url('ubahdata/'.$dt->id)}}">
{{--                            {{csrf_field()}}--}}
                            <div class="box-body">
...
{{--                                </div>--}}
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" name="password" placeholder="Ex: Arief@ymail.com" required>
                                </div>

                                <div class="form-group">
                                    <label>Telp</label>
                                    <input type="number" class="form-control" name="telp" placeholder="Ex: 08921XXX" value="{{$dt->tlp}}" required>
                                </div>
