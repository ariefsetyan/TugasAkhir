...
{{--                                <input type="hidden" class="form-control" name="email" value="{{ Auth::user()->email }}">--}}
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" style="width: 100%;" name="dokumen">
                                        <option selected="selected" value="{{$data->id}}">{{$data->kode_jenis}}/{{$data->nama_dokumen}}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="tglpinjam" value="{{$data->tgl_pinjam}}">
                                </div>
                                <div class="form-group">
                                    <label>Tanggal Kembali</label>
                                    <input type="date" class="form-control" name="tglkembali" value="{{$data->tgl_kembali}}">
                                </div>
