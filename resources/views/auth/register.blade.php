                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
{{--                                <input id="gender" type="text" class="form-control @error('gender') is-invalid @enderror" name="gender" value="{{ old('gemder') }}" required autocomplete="gender" autofocus>--}}
...
{{--                        lepepone--}}
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="gender" type="text" class="form-control @error('tlp') is-invalid @enderror" name="tlp" value="{{ old('tlp') }}" required autocomplete="tlp" autofocus>
                                @error('tlp')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
